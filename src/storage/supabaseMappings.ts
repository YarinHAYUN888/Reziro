...
export function bookingFromRow(row: Record<string, unknown>): Booking {
  ...
  return {
    ...
    vatEnabled: r.vatEnabled != null ? Boolean(r.vatEnabled) : (r.vat_enabled != null ? Boolean(r.vat_enabled) : undefined),
    vatAmount: r.vatAmount != null ? Number(r.vatAmount) : (r.vat_amount != null ? Number(r.vat_amount) : undefined),
    totalAmount: r.totalAmount != null ? Number(r.totalAmount) : (r.total_amount != null ? Number(r.total_amount) : undefined),
